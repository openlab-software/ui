...
import * as styles from "@patrick-ui/core/navigation-menu/navigation-menu.css";
...
NavigationMenuTrigger.displayName = "PatrickUINavigationMenuTrigger";
export function NavigationMenuPopup(props: NavigationMenuPopupProps) {
  return <NavBase.Popup className={styles.popup} {...props} />;
}
NavigationMenuPopup.displayName = "PatrickUINavigationMenuPopup";
...
NavigationMenuViewport.displayName = "PatrickUINavigationMenuViewport";
...
NavigationMenuBackdrop.displayName = "PatrickUINavigationMenuBackdrop";
export function NavigationMenuArrow(props: NavigationMenuArrowProps) {
  return <NavBase.Arrow className={styles.arrow} {...props} />;
}
NavigationMenuArrow.displayName = "PatrickUINavigationMenuArrow";
