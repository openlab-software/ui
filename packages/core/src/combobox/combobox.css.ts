...
export const root = style({ position: "relative", display: "inline-flex", flexDirection: "column", gap: "0.25rem" });
...
export const empty = style({ padding: "0.75rem", fontSize: "0.875rem", color: vars.color.mutedForeground });
export const group = style({});
export const groupLabel = style({ padding: "0.25rem 0.75rem", fontSize: "0.75rem", fontWeight: 600, color: vars.color.mutedForeground });
